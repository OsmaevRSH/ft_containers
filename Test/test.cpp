...
//
//	ft_map_ft.insert(std::make_pair(78, "ok"));
//	ft_map_ft.insert(std::make_pair(90, "kk"));
//	ft_map_ft.insert(++ft_map_ft.begin(), std::make_pair(33, "hi"));
//	ft_map_ft.insert(std::make_pair(7, "lo"));
//	std::pair<ft::map<int, std::string>::iterator, bool> ft_pair = ft_map_ft.insert(std::make_pair(48, "io"));
//
...
//	std::cout << RESET << std::endl;
//
//	std::pair<ft::map<int, std::string>::iterator, bool> ft_pair_s = ft_map_ft.insert(std::make_pair(48, "other"));
...
//
//	std::pair<ft::map<int, std::string>::iterator, ft::map<int, std::string>::iterator> ft_eq = ft_map_f.equal_range(33);
...
//	std::cout << RESET << std::endl;
//
//	std::pair<ft::map<int, std::string>::const_iterator , ft::map<int, std::string>::const_iterator > ft_eq_c = ft_map_f.equal_range(32);
